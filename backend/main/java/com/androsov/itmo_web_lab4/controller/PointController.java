...
import com.androsov.itmo_web_lab4.exception.PointNotFoundException;
import com.androsov.itmo_web_lab4.model.PointModelAssembler;
import com.androsov.itmo_web_lab4.model.User;
import com.androsov.itmo_web_lab4.repository.PointRepository;
...
public class PointController {
    ...
    public CollectionModel<EntityModel<Point>> getAllPoints() {
        ...
        List<EntityModel<Point>> points = repository.findAllByUserId(userid)
                .stream()
